...
public class PersonInitService {
    ...
    //修改员工信息
    public Integer modifyAllInfo(String name,String gender,String pid,String stu_num,Integer age,String pas){
        return  personMapper.modifyAllInfo(name,gender,pid,stu_num,age,pas);}
